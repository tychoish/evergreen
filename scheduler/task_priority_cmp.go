...
//
// Ideally for patch builds we could somehow prioritize a *users*
// newer builds, while still generally preferring older patch builds.
...
func tasksArePatchBuilds(t1, t2 task.Task) bool {
	if t1.Requester == evergreen.PatchVersionRequester ||
		t2.Requester == evergreen.PatchVersionRequester {
...
func tasksAreCommitBuilds(t1, t2 task.Task) bool         { return !tasksArePatchBuilds(t1, t2) }
func tasksAreFromOneProject(t1, t2 task.Task) bool       { return t1.Project == t2.Project }
func tasksArFromDifferentProjects(t1, t2 task.Task) bool { return t1.Project != t2.Project }
